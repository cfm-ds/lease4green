...
shinyUI(fluidPage(theme = shinytheme("flatly"),
  ...
  sidebarLayout(
    ...
    mainPanel(
      p("Using the calculator is really easy. Fill in the desired horsepower, transmission type, car weight (in pounds) and fuel type on the left."),
      p("We will estimate MPG and associated CO2 emissions per in g/km, without being responsible for any errors in the calculation."),
